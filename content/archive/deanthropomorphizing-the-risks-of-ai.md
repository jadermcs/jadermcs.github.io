...
The analogy of anthropomorphizing AI to explain these terms led people to intuitively dismiss all the conclusions from this discussion. When an AI "cuts off a finger" or "manipulates social media to increase tension between the USA, Russia, and China, leading to a nuclear war that ends human life and consequently achieves the objective of ending world famine," it is purely following the objective we designed. The problem, as in the myth of Midas, is that the outcomes of our wishes will highly likely by the means we do not intend. An AI needs no will and no awareness to be dangerous. The program is started with one purpose, and some hours later it is doing something harmful to people to achieve that purpose, not because it is conscious of what it is doing, but precisely because it is not.
